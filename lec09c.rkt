...
# What is the final result of this one? (It is 2.)

# But what if we wrote this program:
...
# What is the final result this time (It is 1.)

# So this new semantics captures the fact that two different
# calls to struct constructors (like `count`) actually make
# different things and modifications to thigns in one
# variable might or might not modify things in
# other variables.
