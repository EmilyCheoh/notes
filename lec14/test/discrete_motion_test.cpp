#include "discrete_motion/mvc.h"
#include <catch.h>

ge211::Rectangle const room1{0, 0, 300, 200};
ge211::Rectangle const room2{10, 10, 280, 180};
...
bool inside(ge211::Rectangle const& inner, ge211::Rectangle const& outer)
{
...
void move_right(ge211::Rectangle room)
{
...
void move_left(ge211::Rectangle room)
{
    motion::Model model(room);
    auto player = model.get_player();
...
void move_down(ge211::Rectangle room)
{
    motion::Model model(room);
    auto player = model.get_player();
...
void move_up(ge211::Rectangle room)
{
    motion::Model model(room);
    auto player = model.get_player();
...
void move_out_of_bounds(ge211::Rectangle room)
{
    motion::Model model(room);
    auto player = model.get_player();
